...
/**
 * 스태거 단위(초). `--motion-stagger: 120ms`(globals.css)와 같은 값이다.
...
/**
 * 리빌 지속시간(초). 0.6 → 0.85 → 1.2로 두 번 올렸다(2026-08-05 외부
 * 피드백 "너무 빨리 등장해서 체감이 안 된다" + 사용자 재확인 "아직도
 * 빠르다") — 마케팅의 시네마틱 스케일(`--motion-reveal` 1100ms)과 같은
 * 급이다. 앱(계기판)은 여전히 짧다. expo-out이라 앞이 빨라 1.2s여도
 * 굼뜨게 읽히지 않는다 — 긴 것은 정착 구간이다.
 */
export const REVEAL_DURATION_S = 1.2
