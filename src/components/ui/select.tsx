  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        //   "누르는 버튼"이 아니다. 열려 있는 동안(data-state=open)은 초점
        //   테두리를 유지해서 팝오버와 트리거가 한 덩어리로 읽히게 한다.
        ...
        "hover:border-ring/35 hover:bg-muted/40 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 data-[state=open]:border-ring",
