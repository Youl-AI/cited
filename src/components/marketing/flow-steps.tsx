 ...
 *
 * 나타나는 순서는 `Reveal` 스태거가 만든다. **간격은 기본 스태거의 5배**
 * (0.45s) — 페이지의 다른 리빌은 "한 묶음이 결 따라 들어온다"(90ms)지만,
 * 이 셋은 자막처럼 **한 단계씩 또박또박** 나타나야 순서 자체가 메시지가
 * 된다(2026-08-05 외부 피드백: "1번 나오고 2번 나오고 3번, 텀을 줘라").
 * 핀·스크럽이 없으므로 GSAP을 켜지 않는다 — Motion 트리 하나로 끝난다
 * (혼용 금지).
 *
 * ## 번호는 장식이 아니다
 *
