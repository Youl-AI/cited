 ...
 * - **행동(`GlassPanel`)**: 폼·요금제처럼 사용자가 조작하는 상업 표면.
 *   라운드 유리 유지.
 * - **컨트롤(버튼·입력)**: 기존 라운드 그대로.
 *
 * "읽는 것은 시트, 하는 것은 유리." 페이지 안에서 표면의 모양이 곧 그
 * 콘텐츠의 종류를 말한다.
 *
 * ## 백플레이트
 *
...
export function SpecimenSheet({
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      />
      <div className="relative overflow-hidden border border-border bg-card shadow-elevation-2">
        {children}
      </div>
    </div>
  )
