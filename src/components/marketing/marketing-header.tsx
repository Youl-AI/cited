      ...
      >
        <div className="mx-auto flex h-14 w-full max-w-6xl items-center justify-between gap-2 px-4 sm:h-16 sm:gap-4 sm:px-6">
          ...
          <nav aria-label="주요" className="flex items-center gap-0.5 sm:gap-2">
            <Link
              href="/sign-in"
              className="link-slide rounded-none px-1.5 py-2 text-xs text-muted-foreground hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring sm:px-3 sm:text-sm"
            >
              로그인 · 회원가입
            </Link>
            {cta && (
