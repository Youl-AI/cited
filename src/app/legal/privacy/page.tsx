  ...
  return (
    <>
      ...
      <p>
        ...
        이상 접속 확인을 위한 것이며, 세션 유효기간과 동일하게 최대 30일간 보관된 후 자동으로
        만료됩니다(서비스를 계속 이용하면 만료 시점이 하루 단위로 갱신되어, 로그인 상태가
        유지되는 동안에는 순환 보관됩니다).
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          이용하면 만료 시점이 하루 단위로 갱신되며, 로그아웃하거나 세션이 만료되면 더 이상
          갱신되지 않고 순차적으로 삭제됩니다.
        </li>
      ...
      <ul>
        ...
        <li>배포된 서비스는 이용자와 서버 간 통신 전 구간에 HTTPS 암호화를 강제합니다.</li>
        <li>
      ...
      <p>
        회사는 로그인 세션을 유지하기 위해 쿠키를 사용합니다. 쿠키는 브라우저 종료 또는 만료
        시까지 이용자의 로그인 상태를 기억하는 역할을 하며, 이용자를 식별할 수 있는 별도의
        광고·추적 쿠키는 사용하지 않습니다.
      </p>
      <p>
