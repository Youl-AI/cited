 ...
 *   바뀌면 따라 바뀐다.
 * ★ 9% → 12% (2026-08-05 외부 피드백: "권장 스타터를 배경색으로 더 확실하게
 *   분리해라"). 원장이 종이(라이트)로 반전되면서 틴트의 바닥이 흰색이 됐고,
 *   흰 종이 위 12% 브랜드 혼합은 띠로 또렷하되 본문 대비는 여전히 13:1 이상
 *   (본문 --foreground는 흰 카드에서 17.64:1 — 혼합분만큼만 내려간다)이라
 *   AA 여유가 크다.
 */
const RECOMMENDED_TINT = 'bg-[color-mix(in_oklch,var(--card),var(--primary)_12%)]'
